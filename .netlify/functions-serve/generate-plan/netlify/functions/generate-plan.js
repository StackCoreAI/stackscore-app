...
var HAS_KEY = !!process.env.OPENAI_API_KEY;
var client = HAS_KEY ? new import_openai.default({ apiKey: process.env.OPENAI_API_KEY }) : null;
...
var CATALOG = [
  ...
  app("Pi\xF1ata", "https://www.pinata.ai", ["Rewards + rent reporting"], { tags: ["rent", "rewards"], cost: 0 }),
...
function pickApps(answers, stackKey) {
  ...
  const seen = /* @__PURE__ */ new Set(), chosen = [];
