...
import type { NextApiRequest, NextApiResponse } from 'next'; // remove if not on Next.js
import {
  LLMPlansSchema,
  sanitizeLLM,
  fromLLMPlans,
  ...
  type LLMPlans,
} from '../shared/plan'; // adjust path as needed

// ---------------------------------------------------------------------------
// Simple in-memory cache (swap with Redis later)
// key: sha256(wizard answers) -> { legacy: LLMPlans, advisor: AdvisorResponse, at }
// ---------------------------------------------------------------------------
