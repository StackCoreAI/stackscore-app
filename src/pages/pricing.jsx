      ...
      >
        <div className="text-center space-y-4">
          ...
          <p className="mx-auto max-w-2xl text-lg text-neutral-300">
            You’re not buying a list of apps. You’re unlocking a{" "}
            <span className="text-white font-semibold">personalized credit strategy</span> that
            combines the right tools so they work together.
          </p>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-6 shadow-xl shadow-lime-500/10">
              ...
              <div className="mt-5 space-y-2 text-sm text-neutral-300">
                <div className="flex items-center gap-2">
                  <span className="text-lime-300">✓</span> Full route + reroutes
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-lime-300">✓</span> Step-by-step activation
                </div>
                <div className="flex items-center gap-2">
